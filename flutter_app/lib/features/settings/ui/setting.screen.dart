...
class _SettingsScreenState extends State<SettingsScreen> {
                    ...
                    child: Column(
                      children: [
                        _buildSwitchItem(
                          ...
                          value: _notifyGeneration,
                          onChanged: (v) =>
                              setState(() => _notifyGeneration = v),
                          icon: Icons.check_circle_rounded,
                        ),
                        _buildSwitchItem(
                          label: 'Collaboration Updates',
                          value: _notifyCollaboration,
                          onChanged: (v) =>
                              setState(() => _notifyCollaboration = v),
                          icon: Icons.people_rounded,
                        ),
                        _buildSwitchItem(
                          label: 'Insight Suggestions',
                          value: _notifyInsights,
                          onChanged: (v) => setState(() => _notifyInsights = v),
  ...
  Widget _buildPremiumBanner() {
    ...
    final planName = _userPlan == 'enterprise'
        ? 'Enterprise'
        : _userPlan == 'pro'
        ? 'Pro'
        : 'Free';
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  isPro
                      ? _planExpiresAt.isNotEmpty
                            ? 'Expires: $_planExpiresAt'
                            : 'Active'
                      : '10 diagrams / month',
                  style: TextStyle(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              '$_projectsCount Projects / $_diagramsCount Diagrams',
              style: TextStyle(
                fontSize: AppSizes.fontXs,
                color: AppColors.textTertiary,
              ),
